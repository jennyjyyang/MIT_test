...
OUTPUT_PATH = "output/bertopic02.json"
SAVE_MODEL_PATH = "output/bertopic02_model"
EMBEDDING_MODEL = SentenceTransformer("shibing624/text2vec-base-chinese")  # paraphrase-multilingual-mpnet-base-v2
MIN_TOPIC_SIZE = 2
